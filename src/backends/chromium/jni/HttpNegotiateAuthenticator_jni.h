...
static void SetResult(JNIEnv* env, const base::android::JavaParamRef<jobject>&
    jcaller,
...
JNI_GENERATOR_EXPORT void
    ...
    jint status,
    jstring authToken) {
  return SetResult(env, base::android::JavaParamRef<jobject>(env, jcaller),
      nativeJavaNegotiateResultWrapper, status,
